...
input ENUM_STRATEGY Strategy_M30 = STRAT_AC;    // Strategy on M30
input ENUM_STRATEGY Strategy_H1 = STRAT_OSMA;   // Strategy on H1
input ENUM_STRATEGY Strategy_H2 = STRAT_SAR;    // Strategy on H2
...
#endif
input int EA_SignalOpenFilterMethod = 45;  // Open (1=!BarO,2=Trend,4=PP,8=OppO,16=Peak,32=BetterO,64=!Eq<1%)
...
input ENUM_EA_ADV_COND EA_Task2_If = EA_ADV_COND_TRADE_EQUITY_GT_01PC;         // 2: Task's condition
