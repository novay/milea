...
// Inputs.
INPUT_GROUP("Force strategy: main");
...
// Includes strategy.
#include "Stg_Force.mqh"

// Defines.
#define ea_name "Strategy Force"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Force"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Force>(Active_Tfs);
