...
// Inputs.
INPUT_GROUP("MACD strategy: main");
...
// Includes strategy.
#include "Stg_MACD.mqh"

// Defines.
#define ea_name "Strategy MACD"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-MACD"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_MACD>(Active_Tfs);
