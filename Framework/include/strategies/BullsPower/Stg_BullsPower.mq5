...
// Inputs.
INPUT_GROUP("BullsPower strategy: main");
...
// Includes strategy.
#include "Stg_BullsPower.mqh"

// Defines.
#define ea_name "Strategy BullsPower"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-BullsPower"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_BullsPower>(Active_Tfs);
