...
// Inputs.
INPUT_GROUP("DeMarker strategy: main");
...
// Includes strategy.
#include "Stg_DeMarker.mqh"

// Defines.
#define ea_name "Strategy DeMarker"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-DeMarker"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_DeMarker>(Active_Tfs);
