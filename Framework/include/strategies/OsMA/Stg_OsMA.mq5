...
// Inputs.
INPUT_GROUP("OsMA strategy: main");
...
// Includes strategy.
#include "Stg_OsMA.mqh"

// Defines.
#define ea_name "Strategy OsMA"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-OsMA"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_OsMA>(Active_Tfs);
