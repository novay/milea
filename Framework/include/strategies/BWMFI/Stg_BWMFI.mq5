...
// Inputs.
INPUT_GROUP("BWMFI strategy: main");
...
// Includes strategy.
#include "Stg_BWMFI.mqh"

// Defines.
#define ea_name "Strategy BWMFI"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-BWMFI"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_BWMFI>(Active_Tfs);
