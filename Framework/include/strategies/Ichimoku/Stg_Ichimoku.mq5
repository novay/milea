...
// Inputs.
INPUT_GROUP("Ichimoku strategy: main");
...
// Includes strategy.
#include "Stg_Ichimoku.mqh"

// Defines.
#define ea_name "Strategy Ichimoku"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Ichimoku"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Ichimoku>(Active_Tfs);
