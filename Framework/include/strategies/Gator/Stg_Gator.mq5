...
// Inputs.
INPUT_GROUP("Gator strategy: main");
...
// Includes strategy.
#include "Stg_Gator.mqh"

// Defines.
#define ea_name "Strategy Gator"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Gator"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Gator>(Active_Tfs);
